...
function tokeniseABC(abc) {
  ...
  const music = musicLines.join(' ')
    .replace(/\(3:?([A-Ga-g])([A-Ga-g])([A-Ga-g])(?![\/0-9])/g, '$12/3$22/3$32/3')//handle simple triplets of the form (3CDE 
    .replace(/\(3:?([A-Ga-g])\/([A-Ga-g])\/([A-Ga-g])\/(?![\/0-9])/g, '$11/3$21/3$31/3')//handle triplets of the form (3C/D/E/ 
    .replace(/\(3:?([A-Ga-g])2([A-Ga-g])2([A-Ga-g])2(?![\/0-9])/g, '$14/3$24/3$34/3')//handle triplets of the form (3C2D2E2
...
G2B`;
  ...
  assert(objSub2.rhythmicDivisions && objSub2.rhythmicDivisions.length === 3, 
