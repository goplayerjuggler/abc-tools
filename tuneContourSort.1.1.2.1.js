...
// // Base character for encoding (ASCII 'A')
// const baseChar = 0x0041;
...
FD(3EFG A2AB cAdB cAG2 |` 
  ...
  assert(objTriplet.rhythmicDivisions[0].divisor === 3, 'Triplet has divisor 3');
  assert(objSixteenth.rhythmicDivisions[0].divisor === 2, 'Sixteenth has divisor 2');
